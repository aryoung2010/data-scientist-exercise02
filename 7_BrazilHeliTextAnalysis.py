...
############################################################
#
# The text narratives for brazilian helicopter accidents
# are identical in format, and so many words will need to
# be removed in addition to stop words. 

# However there are some useful keywords that remain that 
# could allude to circumstances that caused the aircraft to
# crash. I ran out of time for this exercise, but ideally
# I would have continued with this analysis to see if the 
# mast bumping hypothesis discovered through internet 
# research also appears in the data.
#
...
# commercial flight aand incident ccident reports
...
### This was an attempt to pull all the data together into a single list to 
## analyze for frequencies after dropping irrelevant words that were common
## to every report. However, as time ticked on, I decid to focus on the 
## visualizations of the final report and come back to this, but alas ran
## out of time prior to the deadline. 
